...
\end{align}
In \cref{fig:testsingle,fig:testsingle2,fig:testsingle3,fig:testsingle4}, a spacetime matrix plot of the expactation value $\braket{S_i^z}_t$ is  plotted for $\lambda=0$ and different values of anisotropy $\mu$. 
\begin{figure}[]
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{Sz_l1_0.tex}}
        \caption{$\lambda=1$}
        \label{fig:testsingle}
    \end{subfigure}
    \caption{BDbJBWDBSLBDJLBWUDBJLSBDJKLBWÖJKFBÖJKBFJÖKSBJFBSJF}
\end{figure}
