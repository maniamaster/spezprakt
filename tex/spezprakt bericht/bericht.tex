...
\begin{figure}[]
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l0_mu0_0.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l0_mu0_8.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle2}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l0_mu1_2.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle3}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l0_mu2_0.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle4}
    \end{subfigure}
    \caption{BLAAKJDGJKADJAGDJADGJD}
\end{figure}

\begin{figure}[]
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l06_mu0_0.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle5}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l06_mu0_8.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle6}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l06_mu1_2.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
        \label{fig:testsingle7}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{figures/Sz_l06_mu2_0.tex}}
        \caption{captionsjdijajdkjsakdjfdkjsafashfasdlkwodkweodkefheufhsdjfd}
